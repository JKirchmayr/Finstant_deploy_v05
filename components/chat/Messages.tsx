    ...
    <div className={cn("overflow-y-auto px-2 pt-4 space-y-2 noscroll flex-1 min-h-0")}>
          ...
          >
            <div
              className={cn("max-w-full text-sm leading-relaxed px-3 py-1 rounded-md", {
                "ml-auto bg-secondary border px-4 py-1 font-[500] rounded-md max-w-xs  ": isUser,
      ...
      {isStreaming && streamingMessage && (
        <div className="flex justify-start">
          <div className="max-w-full text-sm leading-relaxed px-3 py-1 mr-auto border-none rounded-md">
